...
syn keyword bladeTarget cc_binary cc_library cc_plugin cc_test gen_rule lex_yacc_library proto_library java_jar swig_library
syn keyword bladeArg name srcs deps incs pre_build dynamic_link link_all_symbols extra_cppflags testdata outs cmd outs
